...
/* Object interface: IMyMath, ver. 0.0,
   GUID={0x11612bfb,0xe83b,0x425b,{0xb7,0x0f,0x70,0x00,0x22,0xa0,0x1a,0x12}} */
...
CINTERFACE_PROXY_VTABLE(11) _IMyMathProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IMyMath::Fun41 */ ,
    (void *) (INT_PTR) -1 /* IMyMath::Fun42 */ ,
    (void *) (INT_PTR) -1 /* IMyMath::Fun43 */
};
...
EXTERN_C const ExtendedProxyFileInfo AutoSvr_ProxyFileInfo = 
{
