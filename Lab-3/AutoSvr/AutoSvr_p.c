...
static const MIDL_SERVER_INFO IMyMath_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(14) _IMyMathProxyVtbl = 
{
    &IMyMath_ProxyInfo,
    &IID_IMyMath,
    ...
    (void *) (INT_PTR) -1 /* IMyMath::get_Param1 */ ,
    (void *) (INT_PTR) -1 /* IMyMath::put_Param1 */
};
...
/* Object interface: IVer, ver. 0.0,
   GUID={0xFD72FEAC,0x8A20,0x4B5A,{0xA4,0x91,0xCC,0x8B,0x25,0x07,0x05,0xAA}} */
...
int __stdcall _AutoSvr_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _AutoSvr, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _AutoSvr, 2, *pIndex )
