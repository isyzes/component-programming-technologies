...
int main(int argc, char* argv[])
{
	...
	//Компьютер\HKEY_LOCAL_MACHINE\SOFTWARE\Classes\Server40332.MathComponent - есть
	//Компьютер\HKEY_LOCAL_MACHINE\SOFTWARE\Classes\Server40332.MathComponent.1 - есть
	//Компьютер\HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Classes\CLSID\{E06DF13A-55C5-460E-ABEE-C28E19562FBE} - есть


	const char* szProgID = "Server40332.MathComponent.1";
	...
	IMath* pMath = NULL;
	hr = pUnk -> QueryInterface(IDD_IMATH, (LPVOID*)&pMath);
	pUnk -> Release();
	if (FAILED(hr))
	{
